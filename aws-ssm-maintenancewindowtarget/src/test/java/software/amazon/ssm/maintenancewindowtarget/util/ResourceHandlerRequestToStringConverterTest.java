...
public class ResourceHandlerRequestToStringConverterTest {
    ...
    private static final ResourceModel DESIRED_RESOURCE_STATE = ResourceModel.builder().windowTargetId(DESIRED_RESOURCE_STATE_WINDOW_TASK_ID).build();
    private static final ResourceModel PREVIOUS_RESOURCE_STATE = ResourceModel.builder().windowTargetId(PREVIOUS_RESOURCE_STATE_WINDOW_TASK_ID).build();
