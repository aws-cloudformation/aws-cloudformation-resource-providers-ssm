    ...
    protected ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        return ProgressEvent.progress(model, callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-SSM-MaintenanceWindowTarget::Create", proxyClient, model, callbackContext)
            ...
            .then(progress ->
                ...
                proxy.initiate("AWS-SSM-MaintenanceWindowTarget::postCreate", proxyClient, model, callbackContext)
