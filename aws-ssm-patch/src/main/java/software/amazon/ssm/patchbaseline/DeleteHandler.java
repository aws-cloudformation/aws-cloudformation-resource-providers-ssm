...
public class DeleteHandler extends BaseHandler<CallbackContext> {
    ...
    public ProgressEvent<ResourceModel, CallbackContext> handleRequest(
        ...
        try {
            ...
            //Now delete the patch baseline. For nonexistent baselines, this should return success and the
            //CloudFormation Delete should succeed.
            ...
            System.out.print(String.format("INFO Deleted patch baseline %s successfully %n", baselineId));
    ...
    private void removePatchGroupsFromBaseline(final String baselineId,
        ...
        try {
            ...
            logger.log(String.format("test delete request baselineId %s %n", baselineId));
            System.out.print(String.format("test delete request baselineId %s %n", baselineId));
            ...
            logger.log(String.format("test delete response baselineId %s", getPatchBaselineResponse.baselineId()));
            System.out.print(String.format("test delete response baselineId %s", getPatchBaselineResponse.baselineId()));
            ...
            System.out.print(String.format("INFO Deregistered group(s) from patch baseline %s %n", baselineId));
            ...
            System.out.print(String.format("INFO Unable to retrieve group(s) for patch baseline %s."
                    + "The baseline might not exist. %n", baselineId));
        }
    }
}
