...
public class AbstractTestBase {
	...
	static ProxyClient<SsmClient> MOCK_PROXY(
		...
		return new ProxyClient<SsmClient>() {
			...
			@Override
			public <RequestT extends AwsRequest, ResponseT extends AwsResponse> CompletableFuture<ResponseT> injectCredentialsAndInvokeV2Async(RequestT requestT,
				Function<RequestT, CompletableFuture<ResponseT>> function) {
			...
			public <RequestT extends AwsRequest, ResponseT extends AwsResponse, IterableT extends SdkIterable<ResponseT>> IterableT injectCredentialsAndInvokeIterableV2(
				RequestT requestT, Function<RequestT, IterableT> function) {
